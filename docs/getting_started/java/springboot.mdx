...
With the GraphQL endpoint up and running, the next step is introspecting and try out some more queries. 
...
:::note
You can also customize certain default behaviors of GraphQLize in future releases.
:::
