...
Congrats! You are on course to build impressive applications using GraphQLize in less time. To save yourself some more time, do refer [this documentation](../../graphql_schema/types_and_fields) to know more about how GraphQLize generates the GraphQL schema and the queries. 
