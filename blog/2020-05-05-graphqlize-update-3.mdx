...
The third iteration of [GraphQLize](https://www.graphqlize.org) went well as planned the filters in GraphQLize just got better :). 
...
For example, to get all the cities of a county using the country's name in the above schema, We can query it as 
